...
| S2 | Simple | BlueBoat | One water-temperature reading at W1 | `blueboat_temperature_logging.xml` | Implemented catalogue |
...
2. Record physical BlueBoat ROS/Gazebo execution evidence separately as E5;
...
5. Decide whether S1, M1, C1, S2, and C3 are the final execution subset.
